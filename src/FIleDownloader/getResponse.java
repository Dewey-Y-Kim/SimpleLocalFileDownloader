...
public class getResponse {
    public HttpURLConnection getHttpURLConnection(String strUrl, String method) {
        ...
        try {
            ...
            connect = (HttpURLConnection) url.openConnection(); //HttpURLConnection 객체 생성
            connect.setRequestMethod(method); //Method 방식 설정. GET/POST/DELETE/PUT/HEAD/OPTIONS/TRACE
            connect.setConnectTimeout(5000); //연결제한 시간 설정. 5초 간 연결시도
